...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "arrangements.drawerDesc": "记录待办，不必现在处理",
    "arrangements.create": "新建",
    "arrangements.createTitle": "新建安排",
    "arrangements.editTitle": "编辑安排",
    "arrangements.editAction": "编辑",
    "arrangements.detailTitle": "安排详情",
    "arrangements.emptyTitle": "还没有安排",
    "arrangements.emptyDesc": "写下一件你想做的事就好，不必一次想全。",
    "arrangements.activeSection": "进行中",
    "arrangements.laterSection": "以后再说",
    "arrangements.laterHint": "暂时收在这里，不必现在处理。",
    "arrangements.completedSection": "已完成",
    "arrangements.expand": "展开",
    "arrangements.collapse": "收起",
    "arrangements.moveLater": "以后再说",
    "arrangements.restoreActive": "放回进行中",
    "arrangements.markComplete": "标记完成",
    "arrangements.markIncomplete": "恢复进行中",
    "arrangements.delete": "删除",
    "arrangements.fieldTitle": "标题",
    "arrangements.fieldTitlePlaceholder": "例如：明天整理会议纪要",
    "arrangements.fieldNote": "备注",
    "arrangements.fieldNotePlaceholder": "可选，补充一点背景",
    "arrangements.fieldTime": "时间",
    "arrangements.fieldTimeHint": "可选。不设置时间也没关系。",
    "arrangements.clearTime": "清除时间",
    "arrangements.noTime": "未设置时间",
    "arrangements.statusActive": "进行中",
    "arrangements.statusLater": "以后再说",
    "arrangements.statusCompleted": "已完成",
    "arrangements.timeToday": "今天",
    "arrangements.timeTomorrow": "明天",
    "arrangements.timeYesterday": "昨天",
    "arrangements.closeEditor": "关闭编辑",
    "arrangements.aiSettingsTitle": "AI 接口配置",
    "arrangements.aiSettingsDesc": "密钥仅保存在本机，请求直连你配置的模型服务，由你自行承担 Token 消耗。",
    "arrangements.aiApiKey": "API Key",
    "arrangements.aiApiKeyPlaceholder": "sk-...",
    "arrangements.aiBaseUrl": "接口地址",
    "arrangements.aiModel": "模型名称",
    "arrangements.aiPrivacyNote": "本项目不会上传或收集你的密钥与对话内容。",
    "arrangements.aiSaved": "已保存",
    "arrangements.aiSettingsShort": "配置",
    "arrangements.calendarTitle": "日历总览",
    "arrangements.calendarPrev": "上个月",
    "arrangements.calendarNext": "下个月",
    "arrangements.calendarDayList": "当日安排",
    "arrangements.calendarUnscheduled": "未定时",
    "arrangements.calendarUnscheduledHint": "可以稍后再补充时间，不必着急。",
    "arrangements.needsTimeHint": "暂未识别到具体时间，你可以手动补充，也可以先放着。",
    "arrangements.sourceExcerpt": "来自对话",
    "arrangements.extractHint": "从最近对话中识别待办，结果会写入安排列表。",
    "arrangements.extractAction": "识别安排",
    "arrangements.extractNeedConfig": "请先配置 API Key、接口地址和模型名称。",
    "arrangements.extractEmpty": "未识别到新的安排，可以换个说法或手动新建。",
    "arrangements.extractSuccess": "已添加 {count} 条安排",
    "arrangements.extractSuccessWithTime": "已添加 {count} 条安排，其中 {needsTime} 条可补充时间",
    "arrangements.extractFailed": "识别失败，请检查配置或稍后重试",
    "arrangements.openList": "查看安排",
  },
  "zh-TW": {
    "tabs.records": "快記",
    "tabs.insight": "洞見",
    ...
    "arrangements.title": "安排",
    "arrangements.drawerDesc": "記錄待辦，不必現在處理",
    "arrangements.create": "新建",
    "arrangements.createTitle": "新建安排",
    "arrangements.editTitle": "編輯安排",
    "arrangements.editAction": "編輯",
    "arrangements.detailTitle": "安排詳情",
    "arrangements.emptyTitle": "還沒有安排",
    "arrangements.emptyDesc": "寫下一件你想做的事就好，不必一次想全。",
    "arrangements.activeSection": "進行中",
    "arrangements.laterSection": "以後再說",
    "arrangements.laterHint": "暫時收在這裡，不必現在處理。",
    "arrangements.completedSection": "已完成",
    "arrangements.expand": "展開",
    "arrangements.collapse": "收起",
    "arrangements.moveLater": "以後再說",
    "arrangements.restoreActive": "放回進行中",
    "arrangements.markComplete": "標記完成",
    "arrangements.markIncomplete": "恢復進行中",
    "arrangements.delete": "刪除",
    "arrangements.fieldTitle": "標題",
    "arrangements.fieldTitlePlaceholder": "例如：明天整理會議紀要",
    "arrangements.fieldNote": "備註",
    "arrangements.fieldNotePlaceholder": "可選，補充一點背景",
    "arrangements.fieldTime": "時間",
    "arrangements.fieldTimeHint": "可選。不設置時間也沒關係。",
    "arrangements.clearTime": "清除時間",
    "arrangements.noTime": "未設置時間",
    "arrangements.statusActive": "進行中",
    "arrangements.statusLater": "以後再說",
    "arrangements.statusCompleted": "已完成",
    "arrangements.timeToday": "今天",
    "arrangements.timeTomorrow": "明天",
    "arrangements.timeYesterday": "昨天",
    "arrangements.closeEditor": "關閉編輯",
    "arrangements.aiSettingsTitle": "AI 介面設定",
    "arrangements.aiSettingsDesc": "金鑰僅保存在本機，請求直連你設定的模型服務。",
    "arrangements.aiApiKey": "API Key",
    "arrangements.aiApiKeyPlaceholder": "sk-...",
    "arrangements.aiBaseUrl": "介面位址",
    "arrangements.aiModel": "模型名稱",
    "arrangements.aiPrivacyNote": "本專案不會上傳或收集你的金鑰與對話內容。",
    "arrangements.aiSaved": "已儲存",
    "arrangements.aiSettingsShort": "設定",
    "arrangements.calendarTitle": "日曆總覽",
    "arrangements.calendarPrev": "上個月",
    "arrangements.calendarNext": "下個月",
    "arrangements.calendarDayList": "當日安排",
    "arrangements.calendarUnscheduled": "未定時",
    "arrangements.calendarUnscheduledHint": "可以稍後再補充時間，不必著急。",
    "arrangements.needsTimeHint": "暫未識別到具體時間，你可以手動補充，也可以先放著。",
    "arrangements.sourceExcerpt": "來自對話",
    "arrangements.extractHint": "從最近對話中識別待辦，結果會寫入安排列表。",
    "arrangements.extractAction": "識別安排",
    "arrangements.extractNeedConfig": "請先設定 API Key、介面位址和模型名稱。",
    "arrangements.extractEmpty": "未識別到新的安排。",
    "arrangements.extractSuccess": "已新增 {count} 條安排",
    "arrangements.extractSuccessWithTime": "已新增 {count} 條安排，其中 {needsTime} 條可補充時間",
    "arrangements.extractFailed": "識別失敗，請檢查設定或稍後重試",
    "arrangements.openList": "查看安排",
  },
  "en-US": {
    "tabs.records": "Notes",
    ...
    "arrangements.drawerDesc": "Capture tasks without pressure",
    "arrangements.create": "New",
    "arrangements.createTitle": "New plan",
    "arrangements.editTitle": "Edit plan",
    "arrangements.editAction": "Edit",
    "arrangements.detailTitle": "Plan details",
    "arrangements.emptyTitle": "No plans yet",
    "arrangements.emptyDesc": "Start with one small thing. You do not need the full picture.",
    "arrangements.activeSection": "Active",
    "arrangements.laterSection": "Later",
    "arrangements.laterHint": "Kept here gently. No need to handle these now.",
    "arrangements.completedSection": "Completed",
    "arrangements.expand": "Show",
    "arrangements.collapse": "Hide",
    "arrangements.moveLater": "Later",
    "arrangements.restoreActive": "Move back to active",
    "arrangements.markComplete": "Mark done",
    "arrangements.markIncomplete": "Mark active",
    "arrangements.delete": "Delete",
    "arrangements.fieldTitle": "Title",
    "arrangements.fieldTitlePlaceholder": "e.g. Draft meeting notes tomorrow",
    "arrangements.fieldNote": "Note",
    "arrangements.fieldNotePlaceholder": "Optional context",
    "arrangements.fieldTime": "Time",
    "arrangements.fieldTimeHint": "Optional. It is fine to leave this empty.",
    "arrangements.clearTime": "Clear time",
    "arrangements.noTime": "No time set",
    "arrangements.statusActive": "Active",
    "arrangements.statusLater": "Later",
    "arrangements.statusCompleted": "Done",
    "arrangements.timeToday": "Today",
    "arrangements.timeTomorrow": "Tomorrow",
    "arrangements.timeYesterday": "Yesterday",
    "arrangements.closeEditor": "Close editor",
    "arrangements.aiSettingsTitle": "AI settings",
    "arrangements.aiSettingsDesc": "Keys stay on this device. Requests go directly to your model endpoint.",
    "arrangements.aiApiKey": "API key",
    "arrangements.aiApiKeyPlaceholder": "sk-...",
    "arrangements.aiBaseUrl": "API base URL",
    "arrangements.aiModel": "Model",
    "arrangements.aiPrivacyNote": "This demo does not collect your key or conversation content.",
    "arrangements.aiSaved": "Saved",
    "arrangements.aiSettingsShort": "AI",
    "arrangements.calendarTitle": "Calendar",
    "arrangements.calendarPrev": "Previous month",
    "arrangements.calendarNext": "Next month",
    "arrangements.calendarDayList": "Plans this day",
    "arrangements.calendarUnscheduled": "No time yet",
    "arrangements.calendarUnscheduledHint": "You can add a time later. No rush.",
    "arrangements.needsTimeHint": "No specific time yet. Add one when you are ready, or leave it open.",
    "arrangements.sourceExcerpt": "From chat",
    "arrangements.extractHint": "Detect plans from recent messages and save them here.",
    "arrangements.extractAction": "Detect plans",
    "arrangements.extractNeedConfig": "Configure API key, base URL, and model first.",
    "arrangements.extractEmpty": "No new plans were detected.",
    "arrangements.extractSuccess": "Added {count} plans",
    "arrangements.extractSuccessWithTime": "Added {count} plans; {needsTime} need a time",
    "arrangements.extractFailed": "Detection failed. Check settings and try again.",
    "arrangements.openList": "Open plans",
  },
  "ar-SA": {
